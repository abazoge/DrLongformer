#!/bin/bash
#SBATCH --job-name=mlm_longformer_cp     # nom du job
...
srun -l python -u run_training_cp.py \
    --model_name_or_path='./models/Clinical-Longformer' \
    --tokenizer_name='./models/Clinical-Longformer' \
    --path_load_dataset="./data/tokenized_dataset_NACHOS_Clinical-Longformer" \
    --output_dir='./DrLongformer/' \
    --logging_dir='./DrLongformer/logs/' \
